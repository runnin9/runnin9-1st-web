...
const Lang = (() => {
    ...
    const S = {
        ko: {
            ...
            menu_olympic: '챔피언십: 6종목을 차례로 도전',
            menu_free: '원하는 종목만 연습',
            menu_free_locked: '챔피언십을 먼저 완주하세요',
        ...
        en: {
            ...
            menu_olympic: 'Championship: all 6 events in order',
            menu_free: 'Practice any event you like',
            menu_free_locked: 'Finish the Championship first',
        ...
        ja: {
            ...
            subtitle: 'レトロ陸上6種目',
            menu_olympic: 'チャンピオンシップ：6種目に順番に挑戦',
            menu_free: '好きな種目だけ練習',
            menu_free_locked: '先にチャンピオンシップを完走してください',
        ...
        zh: {
            rotate: '请将手机横过来',
            subtitle: '复古田径六项',
            menu_olympic: '锦标赛：依次挑战全部6个项目',
            menu_free: '自由练习任意项目',
            menu_free_locked: '请先完成锦标赛',
        ...
        es: {
            ...
            menu_olympic: 'Campeonato: las 6 pruebas en orden',
            menu_free: 'Practica la prueba que quieras',
            menu_free_locked: 'Termina primero el Campeonato',
